...
<h1 class="text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-brand-400 to-purple-400 mb-6 tracking-tight">ZK Voice Agent</h1>
...
<h2 class="text-4xl font-bold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400 z-10">
...
<h2 class="text-4xl font-bold mb-1 flex items-center gap-4">
<span class="bg-gradient-to-r from-brand-400 to-blue-200 bg-clip-text text-transparent">ZK Voice Agent</span>
</h2>
...
<h3 class="text-lg font-bold text-white mb-2">音声対話 UI</h3>
...
<h3 class="text-lg font-bold text-white mb-2">プライバシー</h3>
...
<h3 class="text-lg font-bold text-white mb-2">AA</h3>
...
<h2 class="text-3xl font-bold mb-6 flex items-center"><span class="text-brand-400 mr-3">Architecture</span>裏側で何が起きているか？</h2>
...
<h2 class="text-3xl font-bold mb-6 text-center text-transparent bg-clip-text bg-gradient-to-r from-amber-200 to-amber-500">最も技術的に困難だった達成</h2>
...
<h3 class="text-xl font-bold text-white mb-2">1. 声紋の秘匿化</h3>
...
<h3 class="text-xl font-bold text-white mb-2">2. 超高度なLLMとの統合</h3>
...
<h2 class="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-200 to-white mb-5 max-w-4xl leading-tight drop-shadow-2xl">
AI時代のための、摩擦ゼロの決済インフラへ
</h2>
